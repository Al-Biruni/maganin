...
import { ContentMaganinComponent } from 'app/entities/content-maganin/content-maganin.component';
...
describe('Component Tests', () => {
  describe('ContentMaganin Management Component', () => {
    let comp: ContentMaganinComponent;
    let fixture: ComponentFixture<ContentMaganinComponent>;
    let service: ContentMaganinService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MaganinTestModule],
        declarations: [ContentMaganinComponent],
        providers: [
          {
        ...
        .overrideTemplate(ContentMaganinComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ContentMaganinComponent);
