...
import { CategoryMaganinComponent } from 'app/entities/category-maganin/category-maganin.component';
...
describe('Component Tests', () => {
  describe('CategoryMaganin Management Component', () => {
    let comp: CategoryMaganinComponent;
    let fixture: ComponentFixture<CategoryMaganinComponent>;
    let service: CategoryMaganinService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MaganinTestModule],
        declarations: [CategoryMaganinComponent],
        providers: [
          {
        ...
        .overrideTemplate(CategoryMaganinComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CategoryMaganinComponent);
