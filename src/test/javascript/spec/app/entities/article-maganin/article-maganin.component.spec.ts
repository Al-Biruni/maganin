...
import { ArticleMaganinComponent } from 'app/entities/article-maganin/article-maganin.component';
...
describe('Component Tests', () => {
  describe('ArticleMaganin Management Component', () => {
    let comp: ArticleMaganinComponent;
    let fixture: ComponentFixture<ArticleMaganinComponent>;
    let service: ArticleMaganinService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MaganinTestModule],
        declarations: [ArticleMaganinComponent],
        providers: [
          {
        ...
        .overrideTemplate(ArticleMaganinComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ArticleMaganinComponent);
