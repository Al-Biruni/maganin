...
import com.dukesdesigns.maganin.service.InvalidPasswordException;
import com.dukesdesigns.maganin.service.MailService;
import com.dukesdesigns.maganin.service.UserService;
import com.dukesdesigns.maganin.service.UsernameAlreadyUsedException;
import com.dukesdesigns.maganin.service.dto.PasswordChangeDTO;
import com.dukesdesigns.maganin.service.dto.UserDTO;
import com.dukesdesigns.maganin.web.rest.errors.EmailAlreadyUsedException;
import com.dukesdesigns.maganin.web.rest.errors.EmailNotFoundException;
import com.dukesdesigns.maganin.web.rest.errors.LoginAlreadyUsedException;
import com.dukesdesigns.maganin.web.rest.vm.KeyAndPasswordVM;
import com.dukesdesigns.maganin.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.dukesdesigns.maganin.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
